...
class InteractiveTelegramClient(TelegramClient):
    def __init__(self, session_user_id, api_id, api_hash,
        ...
        if not loop.run_until_complete(self.is_user_authorized()):
            if telefon is None:
                user_phone = input(
                    '[?] Telefon Numaranız (Örnek: +90xxxxxxxxxx): ')
            else:
                user_phone = telefon
            try:
                ...
                print(
                    "[!] Geçersiz Bir Numara Girdiniz Örnekte Gibi Giriniz. Örnek: +90xxxxxxxxxx")
                exit(1)
            except ValueError:
                print(
                    "[!] Geçersiz Bir Numara Girdiniz Örnekte Gibi Giriniz. Örnek: +90xxxxxxxxxx")
            ...
            while self_user is None:
                code = input(
                    '[?] Telegramdan Gelen Beş (5) Haneli Kodu Giriniz: ')
                try:
                    self_user =\
                        loop.run_until_complete(self.sign_in(code=code))
                except PhoneCodeInvalidError:
                    print(
                        "[!] Kodu Yanlış Yazdınız. Lütfen Tekrar Deneyiniz. [Fazla Deneme Yapmak Ban Yemenize Neden Olur]")
                    ...
                    try:
                        ...
                        print(
                            "[!] 2 Aşamalı Şifrenizi Yanlış Yazdınız. Lütfen Tekrar Deneyiz. [Fazla Deneme Yapmak Ban Yemenize Neden Olur]")
...
if __name__ == '__main__':
    ...
    if secim == 2:
        ...
        try:
            ...
            print(
                "[!] Büyük İhtimal Kodu Yanlış Yazdınız. Lütfen Scripti Yeniden Başlatın.")
            exit(1)
        app = requests.post(
        ...
        if soup.title.string == "Create new application":
            ...
            AppInfo = {"hash": hashh,
                       ...
                       "app_shortname": "asenaus" + str(random.randint(9,
                                                                       99)) + str(time.time()).replace(".",
                                                                                                       ""),
                       "app_url": "",
            ...
            try:
                stringonay = int(
                    input("[?] String Almak İster Misiniz? [Evet için 1 Yazınız]: "))
            except BaseException:
